...
public class MyPageViewHandler {
    ...
    @StreamListener(KafkaProcessor.INPUT)
    public void whenPickedByRider_then_UPDATE_6(@Payload PickedByRider pickedByRider) {
        try {
            if (!pickedByRider.validate()) return;
                // view 객체 조회
            Optional<MyPage> myPageOptional = myPageRepository.findById(Long.valueOf(pickedByRider.getOrderId()));
